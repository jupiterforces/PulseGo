...
window.maybeShowFeedback = maybeShowFeedback;
window.getMistakeUserAnswer = getMistakeUserAnswer;
window.getMistakeCorrectAnswer = getMistakeCorrectAnswer;
window.getStoredMistakesForSession = getStoredMistakesForSession;
window.getStoredMistakes = getStoredMistakes;
window.getResolvedMistakes = getResolvedMistakes;
window.resolveStoredMistakeById = resolveStoredMistakeById;
