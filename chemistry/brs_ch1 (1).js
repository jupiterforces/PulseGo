...
const m1 = [
  ...
  {
    q: "[11-15-savollar quyidagi bemorga oid] Kam harakat kasbga ega yosh ayol (bo'yi 1.6 m, vazni 50 kg) shifokor tavsiya qilgan mashqlarni bajarmaydi. Ovqatlanish bo'yicha anamnezida kuniga o'rtacha 100 gr uglevod, 20 gr oqsil va 40 gr yog'dan iborat taom qabul qilishini ko'rsatyapti. — Ayolning TVI ni toping?",
  ...
  {
    q: "[11-15-savollar quyidagi bemorga oid] Kam harakat kasbga ega yosh ayol (bo'yi 1.6 m, vazni 50 kg) shifokor tavsiya qilgan mashqlarni bajarmaydi. Ovqatlanish bo'yicha anamnezida kuniga o'rtacha 100 gr uglevod, 20 gr oqsil va 40 gr yog'dan iborat taom qabul qilishini ko'rsatyapti. — Bu ayol har kuni qancha kaloriya energiya qabul qiladi?",
  ...
  {
    q: "[16-17-savollar quyidagi bemorga oid] 25 yoshli, taxminan vazni 70 kg atrofidagi erkak kimsasiz orolda (kema halokati sababli) qolib ketgan, yeguligi yo'q, faqat ichimlik suvi mavjud. — Quyida berilgan zaxira energiya manbalaridan qaysi birining erkakni ko'p miqdordagi kaloriya bilan ta'minlash ehtimoli eng kam?",
    a: [
  ...
  },
  {
    ...
    a: ["Glitserol", "Toq zanjirli yog' kislotalar", "Jigar glikogeni", "Keton tanachalar", "Almashinmaydigan yog' kislotalar"],
    correct: 0,
    explanation:
  ...
  },
  {
    ...
    a: ["Vazn kamligi", "Normal", "Ortiqcha vazn", "Semizlik I", "Semizlik II"],
    correct: 2,
    explanation:
  ...
  },
  {
    ...
    a: ["Qandli diabet I tip", "Insulinga rezistentlik sindromi", "Gausher kasalligi", "Past qon bosimi", "O'roqsimon anemiya"],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    a: ["Yuqori AMA", "Qonda insulin miqdori yuqoriligi", "Vazn yo'qotish", "Ozuqalar malabsorbsiyasi", "Qonda keton tanachalarining kamayishi"],
    correct: 2,
    explanation:
  ...
  },
  {
    ...
    a: ["Bosh miya hujayralari", "Muskul hujayralari", "Yog' to'qimasi hujayralari"],
    correct: 0,
    explanation:
  ...
  {
    q: "[31-35-savollar quyidagi vaziyatli masalaga oid] 27 yoshli erkak Yosemit milliy bog'ida hayking qilayotganda adashib qoldi. U 8 kundan so'ng topildi. Qutqarilishidan avval hech qanday ovqat yemagan, faqat suv ichgan. — Bu bemor topilganda uning qonda glyukoza miqdorini normal saqlash uchun uglerod manbayi quyidagi moddalardan qaysi biri bo'lgan?",
    a: ["Jigar glikogeni", "Muskul glikogeni", "Yog' kislotalar", "Triatsilglitserol", "Keton tanachalar"],
    correct: 3,
    explanation:
  ...
  {
    q: "[31-35-savollar quyidagi vaziyatli masalaga oid] 27 yoshli erkak Yosemit milliy bog'ida hayking qilayotganda adashib qoldi. U 8 kundan so'ng topildi. Qutqarilishidan avval hech qanday ovqat yemagan, faqat suv ichgan. — Qaysi hujayra energiya manbayi sifatida faqat glyukozadan foydalanadi?",
  ...
  {
    q: "[31-35-savollar quyidagi vaziyatli masalaga oid] 27 yoshli erkak Yosemit milliy bog'ida hayking qilayotganda adashib qoldi. U 8 kundan so'ng topildi. Qutqarilishidan avval hech qanday ovqat yemagan, faqat suv ichgan. — Quyidagilardan qaysi biri u o'tgan 8 kun davomida qabul qilmagan muhim (almashinmaydigan) ozuqa hisoblanadi?",
    a: ["Sut kislota", "Olein kislota", "Stearin kislota", "EPK", "Palmitin kislota"],
    correct: 3,
    explanation:
  ...
  {
    q: "[31-35-savollar quyidagi vaziyatli masalaga oid] 27 yoshli erkak Yosemit milliy bog'ida hayking qilayotganda adashib qoldi. U 8 kundan so'ng topildi. Qutqarilishidan avval hech qanday ovqat yemagan, faqat suv ichgan. — Quyida berilgan qaysi laboratoriya testi bemorda umumiy oqsil yetishmovchiligi mavjudligi yoki yo'qligiga aniqlik kiritadi?",
    a: ["Albumin", "Qon mochevinasi azoti (QMA)", "Kreatinin", "Ferritin", "Kreatin fosfokinaza (KFK)"],
    correct: 0,
    explanation:
